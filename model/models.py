import numpy as np
import pandas as pd
# data = pd.read_csv(r'F:\core\MegaProject\Dataset\modified_dataset.csv')
# data.sample(5)
# data.shape
# (data['Disease'].unique())
...
rfc = pickle.load(open(r'F:\MegaProject\model\RFC.pkl','rb'))
#test 1
...
symptom_dict
treatment = pd.read_csv(r'F:\MegaProject\model\treatment.csv', encoding="cp1252")
treatment.sample()
